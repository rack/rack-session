  ...
  module Session
    class Encryptor
      ...
      class V2
        ...
        # Cryptography and Output Format:
        #
        #   strict_encode64(version + IV + authentication tag + encrypted data)
        #
        #  Where:
        ...
        #  * authentication tag - 16 bytes authentication tag generates by the GCM mode, covering all the data
        #
        # Considerations about V2:
        #
        # 1) It serializes the message in JSON, period.
        #
